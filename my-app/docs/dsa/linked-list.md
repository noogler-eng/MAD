...
Linked List is a foundational DSA concept used to design efficient algorithms and reason about trade-offs.
...
```text
[ Add an ASCII diagram for Linked List here ]
```
...
procedure solve(input):
  ...
  update state based on Linked List
  return result
```
...
procedure optimizedSolve(input):
  ...
  apply Linked List-specific transitions
...
2. Process each element using Linked List rules.
...
1. **Basic Linked List drill**
   - Prompt: Solve a beginner-friendly problem using Linked List.
   - Hint: Start with a brute-force solution, then optimize.

2. **Advanced Linked List application**
